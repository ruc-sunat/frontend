        ...
        {isPro && (
          <div className="px-3 py-2 border-t border-gray-100">
            <button
              ...
              className="w-full px-3 py-2 bg-blue-50 text-blue-700 text-sm font-medium rounded-lg hover:bg-blue-100 transition-colors flex items-center gap-2 justify-center"
            >
              <span>💬</span>
              Contactar soporte
            </button>
